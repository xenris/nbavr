...
#define vectorCRCSCAN_NMI                                           ISR(__vector_1)
#define vectorBOD_VLM                                               ISR(__vector_2)
#define vectorPORTA_PORT                                            ISR(__vector_3)
#define vectorRTC_CNT                                               ISR(__vector_6)
#define vectorRTC_PIT                                               ISR(__vector_7)
#define vectorTCA0_LUNF                                             ISR(__vector_8)
#define vectorTCA0_HUNF                                             ISR(__vector_9)
#define vectorTCA0_LCMP0                                            ISR(__vector_10)
#define vectorTCA0_LCMP1                                            ISR(__vector_11)
#define vectorTCA0_CMP2                                             ISR(__vector_12)
#define vectorTCB0_INT                                              ISR(__vector_13)
#define vectorAC0_AC                                                ISR(__vector_17)
#define vectorADC0_RESRDY                                           ISR(__vector_20)
#define vectorADC0_WCOMP                                            ISR(__vector_21)
#define vectorTWI0_TWIS                                             ISR(__vector_24)
#define vectorTWI0_TWIM                                             ISR(__vector_25)
#define vectorSPI0_INT                                              ISR(__vector_26)
#define vectorUSART0_RXC                                            ISR(__vector_27)
#define vectorUSART0_DRE                                            ISR(__vector_28)
#define vectorUSART0_TXC                                            ISR(__vector_29)
#define vectorNVMCTRL_EE                                            ISR(__vector_30)

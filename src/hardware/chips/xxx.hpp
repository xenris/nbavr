...
#define CHIP_USART_X_RX_COMPLETE_INT_VECTOR                             VECT(X)
#define CHIP_USART_X_TX_COMPLETE_INT_VECTOR                             VECT(X)
#define CHIP_USART_X_DATA_REG_EMPTY_INT_VECTOR                          VECT(X)

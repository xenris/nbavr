...
TEST(Adc, trigger) {
    ...
    TEST_RAM_WRITE(Adc::trigger(Adc::Trigger::AnalogComparator));
...
TEST(TimerCounter0, counter) {
    TEST_RAM_WRITE(TimerCounter0::counter(0xc4));
...
TEST(TimerCounter0, waveform) {
    TEST_RAM_WRITE(TimerCounter0::waveform(TimerCounter0::Waveform::Normal));
    TEST_RAM_WRITE(TimerCounter0::waveform(TimerCounter0::Waveform::PWM));
    TEST_RAM_WRITE(TimerCounter0::waveform(TimerCounter0::Waveform::CTCOCRA));
    TEST_RAM_WRITE(TimerCounter0::waveform(TimerCounter0::Waveform::FastPWM));
    TEST_RAM_WRITE(TimerCounter0::waveform(TimerCounter0::Waveform::PWMOCRA));
    TEST_RAM_WRITE(TimerCounter0::waveform(TimerCounter0::Waveform::FastPWMOCRA));
}
...
TEST(TimerCounter0, outputA) {
    TEST_RAM_WRITE(TimerCounter0::outputA(0xc8));
    TEST_RAM_READ_WRITE(TimerCounter0::outputA());
}

TEST(TimerCounter0, outputB) {
    TEST_RAM_WRITE(TimerCounter0::outputB(0x7a));
    TEST_RAM_READ_WRITE(TimerCounter0::outputB());
}

TEST(TimerCounter0, outputAMode) {
    TEST_RAM_WRITE(TimerCounter0::outputAMode(TimerCounter0::OutputMode::Disconnected));
    TEST_RAM_WRITE(TimerCounter0::outputAMode(TimerCounter0::OutputMode::Toggle));
    TEST_RAM_WRITE(TimerCounter0::outputAMode(TimerCounter0::OutputMode::Clear));
    TEST_RAM_WRITE(TimerCounter0::outputAMode(TimerCounter0::OutputMode::Set));
}

TEST(TimerCounter0, outputBMode) {
    TEST_RAM_WRITE(TimerCounter0::outputBMode(TimerCounter0::OutputMode::Disconnected));
    TEST_RAM_WRITE(TimerCounter0::outputBMode(TimerCounter0::OutputMode::Toggle));
    TEST_RAM_WRITE(TimerCounter0::outputBMode(TimerCounter0::OutputMode::Clear));
    TEST_RAM_WRITE(TimerCounter0::outputBMode(TimerCounter0::OutputMode::Set));
}

TEST(TimerCounter0, outputACallback) {
    TEST_RAM_WRITE(TimerCounter0::outputACallback(func,data));
}

TEST(TimerCounter0, outputBCallback) {
    TEST_RAM_WRITE(TimerCounter0::outputBCallback(func,data));
}

TEST(TimerCounter0, outputAIntEnable) {
    TEST_RAM_WRITE(TimerCounter0::outputAIntEnable(true));
    TEST_RAM_WRITE(TimerCounter0::outputAIntEnable(false));
}

TEST(TimerCounter0, outputBIntEnable) {
    TEST_RAM_WRITE(TimerCounter0::outputBIntEnable(true));
    TEST_RAM_WRITE(TimerCounter0::outputBIntEnable(false));
}

TEST(TimerCounter0, outputAIntFlag) {
    TEST_RAM_READ_WRITE(TimerCounter0::outputAIntFlag());
}

TEST(TimerCounter0, outputBIntFlag) {
    TEST_RAM_READ_WRITE(TimerCounter0::outputBIntFlag());
}

TEST(TimerCounter0, outputAIntFlagClear) {
    TEST_RAM_WRITE(TimerCounter0::outputAIntFlagClear());
}

TEST(TimerCounter0, outputBIntFlagClear) {
    TEST_RAM_WRITE(TimerCounter0::outputBIntFlagClear());
}
...
TEST(TimerCounter1, outputA) {
    TEST_RAM_WRITE(TimerCounter1::outputA(0xe8d9));
    TEST_RAM_READ_WRITE(TimerCounter1::outputA());
}

TEST(TimerCounter1, outputB) {
    TEST_RAM_WRITE(TimerCounter1::outputB(0x7a8d));
...
TEST(TimerCounter1, outputACallback) {
    TEST_RAM_WRITE(TimerCounter1::outputACallback(func,data));
}

TEST(TimerCounter1, outputBCallback) {
    TEST_RAM_WRITE(TimerCounter1::outputBCallback(func,data));
}

TEST(TimerCounter1, outputAIntEnable) {
    TEST_RAM_WRITE(TimerCounter1::outputAIntEnable(true));
    TEST_RAM_WRITE(TimerCounter1::outputAIntEnable(false));
}

TEST(TimerCounter1, outputBIntEnable) {
    TEST_RAM_WRITE(TimerCounter1::outputBIntEnable(true));
    TEST_RAM_WRITE(TimerCounter1::outputBIntEnable(false));
}

TEST(TimerCounter1, outputAIntFlag) {
    TEST_RAM_READ_WRITE(TimerCounter1::outputAIntFlag());
}

TEST(TimerCounter1, outputBIntFlag) {
    TEST_RAM_READ_WRITE(TimerCounter1::outputBIntFlag());
}

TEST(TimerCounter1, outputAIntFlagClear) {
    TEST_RAM_WRITE(TimerCounter1::outputAIntFlagClear());
}

TEST(TimerCounter1, outputBIntFlagClear) {
    TEST_RAM_WRITE(TimerCounter1::outputBIntFlagClear());
}
...
TEST(TimerCounter2, outputA) {
    TEST_RAM_WRITE(TimerCounter2::outputA(0xed));
    TEST_RAM_READ_WRITE(TimerCounter2::outputA());
}

TEST(TimerCounter2, outputB) {
    TEST_RAM_WRITE(TimerCounter2::outputB(0xd8));
    TEST_RAM_READ_WRITE(TimerCounter2::outputB());
}
...
TEST(TimerCounter2, outputBMode) {
    TEST_RAM_WRITE(TimerCounter2::outputBMode(TimerCounter2::OutputMode::Disconnected));
    TEST_RAM_WRITE(TimerCounter2::outputBMode(TimerCounter2::OutputMode::Toggle));
    TEST_RAM_WRITE(TimerCounter2::outputBMode(TimerCounter2::OutputMode::Clear));
    TEST_RAM_WRITE(TimerCounter2::outputBMode(TimerCounter2::OutputMode::Set));
}

TEST(TimerCounter2, outputACallback) {
    TEST_RAM_WRITE(TimerCounter2::outputACallback(func,data));
}

TEST(TimerCounter2, outputBCallback) {
    TEST_RAM_WRITE(TimerCounter2::outputBCallback(func,data));
}

TEST(TimerCounter2, outputAIntEnable) {
    TEST_RAM_WRITE(TimerCounter2::outputAIntEnable(true));
    TEST_RAM_WRITE(TimerCounter2::outputAIntEnable(false));
}

TEST(TimerCounter2, outputBIntEnable) {
    TEST_RAM_WRITE(TimerCounter2::outputBIntEnable(true));
    TEST_RAM_WRITE(TimerCounter2::outputBIntEnable(false));
}

TEST(TimerCounter2, outputAIntFlag) {
    TEST_RAM_READ_WRITE(TimerCounter2::outputAIntFlag());
}

TEST(TimerCounter2, outputBIntFlag) {
    TEST_RAM_READ_WRITE(TimerCounter2::outputBIntFlag());
}

TEST(TimerCounter2, outputAIntFlagClear) {
    TEST_RAM_WRITE(TimerCounter2::outputAIntFlagClear());
}

TEST(TimerCounter2, outputBIntFlagClear) {
    TEST_RAM_WRITE(TimerCounter2::outputBIntFlagClear());
}
